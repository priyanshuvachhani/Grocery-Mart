...
<body>
    <form method="post">
        ...
        <div style="margin-left:15%; padding:1px 16px;">
            ...
            <table align="center">
                <tr>
					<td><textarea id="desc" class="atexa" name="description" placeholder="Description(use '<br>' before new line )" required></textarea></td></tr>
                <tr>
            ...
            <script>
                document.getElementById('desc').value = '<?php echo $description; ?>';
            </script>
        </div>
    </form>
</body>
